...
from nog.auth.dev_login import github_login_automation
from nog.auth.session import save_session_record, SessionRecord
...
def run_browser_login() -> None:
    ...
    try:
        ...
        save_successful_login(session_record)

def run_dev_login() -> None:
    try:
...
def save_successful_login(session_record: SessionRecord) -> None:
